...
export default function SignIn(props: { disableCustomTheme?: boolean }) {
    ...
    const [snackbar, setSnackbar] = React.useState<{ sopen: boolean; message: string; severity: 'error' | 'info' | 'success' | 'warning' }>({ sopen: false, message: '', severity: 'info' });
    const { sopen, message, severity } = snackbar;

    const handleCloseSnackbar = () => {
        setSnackbar({ ...snackbar, sopen: false });
    };
